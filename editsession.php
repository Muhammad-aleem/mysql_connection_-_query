...
if (isset($_POST['submit'])) {
	...
	$obj->updatesessionData($sessionname,$_GET['editid']);
...
{
	$singlesessiondata = $obj->getSinglesessionData($_GET['editid']);
				...
				<div class="panel panel-primary" data-collapsed="0">
					...
					<div class="panel-heading">
						<div class="panel-title">
							<h1 style="margin-left: 300px; font-size: 40px ">Edit Session</h1>
						</div>
					...
					<div class="panel-body">
						...
						<form action="" method="POST" role="form" class="form-horizontal form-groups-bordered">
							...
							<div class="form-group">
								<label for="field-1" class="col-sm-3 control-label"><b>session</b></label>
								
								<div class="col-sm-5">
									<input type="text" name="session" class="form-control" id="field-1" placeholder="session" value="<?php echo	$singlesessiondata['sessionname'];  ?>">
								</div>
							</div>
							<div class="form-group">
