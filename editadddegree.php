...
$obj->updatedegreeData($degreename,$_GET['editid']);
...
{
	$singledegreedata = $obj->getSingledegreeData($_GET['editid']);
				...
				<div class="panel panel-primary" data-collapsed="0">
					...
					<div class="panel-heading">
						<div class="panel-title">
							<h1 style="margin-left: 300px; font-size: 40px ">Edit Degree</h1>
						</div>
					...
					<div class="panel-body">
						...
						<form action="" method="POST" role="form" class="form-horizontal form-groups-bordered">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" name="degreename" class="form-control" id="field-1" placeholder="Degree" value="<?php echo		$singledegreedata['degreename'];  ?>">
								</div>
							</div>
							<div class="form-group">
