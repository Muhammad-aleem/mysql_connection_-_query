...
if (isset($_POST['submit']))
 {
	...
	$obj->updatesectionData($section,$_GET['editid']);
...
{
	$singlesectiondata = $obj->getSinglesectionData($_GET['editid']);
					...
					<div class="panel-body">
						...
						<form action="" method="POST" role="form" class="form-horizontal form-groups-bordered">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" name="section" class="form-control" id="field-1" placeholder="section" value="<?php echo $singlesectiondata['sectionname'];?>">
