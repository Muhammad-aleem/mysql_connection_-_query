...
if (isset($_POST['submit'])) {
	...
	$obj->editpaymentData($amount,$date,$feestype,$_GET['editid']);
 	header( "location:editviewpayment.php");
}
$fee=$obj->getAllfeesData();

$point=$obj->getAllpaymentData();
if(isset($_GET['editid']))
{
	$singledata = $obj->getSinglepaymentData($_GET['editid']);
...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
	...
	<div class="main-content">					
		<h2  style="margin-left: 200px;font-size: 40px;">Edit_view_Payment</h2>
		<br />
					...
					<div class="panel-body">
						...
						<form role="form" action="" method="POST" class="form-horizontal form-groups-bordered">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text"  name="amount" class="form-control" id="field-1" placeholder="Your Amount--" value="<?php echo $singledata['amount'];?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<select class="form-control" name="feestype" >
										<option>Choose Payment Type</option>
										<?php foreach($fee as $fee):?>
												<?php
											if ($singledata['paymentclass']==$fee['payment_id'])
											 {
												$selected='selected';
											}
											else{
											...
											?>
											<option value="<?php echo $fee['fees_id'];?>"<?php echo $selected;?>><?php echo $fee['feestype'];?></option>
											<?php endforeach;?>
