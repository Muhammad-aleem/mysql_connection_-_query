			...
			<div class="col-md-6 col-sm-8 clearfix">
				...
				<div class="panel panel-primary" data-collapsed="0">
					...
					<div class="panel-body">
						<div>
					<a style="border-radius: 0;padding-left: 20px; margin-left: 300px; font-size: 20px;" href="" class="btn btn-success btn-lg" data-toggle="model" data-target="#exampleModal" >
