...
if (isset($_POST['submit'])) {
	...
	$date=$_POST['date'];
 		...
 		$obj->editInvoicesData($class,$sectionname,$studen,$phone,$rollno,$amount,$date,$_GET['editid']);
...
{
	$singledata = $obj->getSingleinvoiceData($_GET['editid']);
...
<head>
	...
	<title>Edit-view-invoices</title>
...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
	...
	<div class="main-content">					
		<h2 style="margin-left: 200px;font-size: 40px;">Edit-view-Invoices</h2>
		<br />
					...
					<div class="panel-body">
						...
						<form role="form" action="" method="POST" class="form-horizontal form-groups-bordered">
								...
								<div class="col-sm-5">
									<select class="form-control" name="degreename">
										...
										<?php foreach($degreename as $degreename):?>
											<?php
											if ($singledata['class']==$degreename['degree_id'])
											 {
												$selected='selected';
											}
											else{
								...
								<div class="col-sm-5">
									<select class="form-control" name="sectionname">
										...
										<?php foreach($section as$section):?>
											<?php
											if ($singledata['section']==$section['section_id'])
											 {
												$selected='selected';
											}
											else{
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" name="studentname" class="form-control" id="field-1" placeholder=" Enter Your Name" value="<?php echo $singledata['studentname'];?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text"  name="phone" class="form-control" id="field-1" placeholder="Your Roll No" value="<?php echo $singledata['phone'];?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text"  name="rollno" class="form-control" id="field-1" placeholder="Your Roll No" value="<?php echo $singledata['rollno'];?>">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text"  name="amount" class="form-control" id="field-1" placeholder="Enter Amount" value="<?php echo $singledata['amount'];?>">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="date"  name="date" class="form-control" id="field-1" placeholder="" value="<?php echo $singledata['date'];?>">
								</div>
							</div>
