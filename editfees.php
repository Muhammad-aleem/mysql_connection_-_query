...
if (isset($_POST['submit'])) {
	...
	$obj->updatefeesData($feestype,$_GET['editid']);
...
{
	$getSinglefeesData = $obj->getSinglefeesData($_GET['editid']);
...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
	...
	<div class="main-content">					
		<h2 style="margin-left: 200px;font-size: 50px;">Edit_Fees</h2>
		<br />
					...
					<div class="panel-body">
						...
						<form role="form" action="" method="POST" class="form-horizontal form-groups-bordered" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" name="feestype" class="form-control" id="field-1" placeholder=" Enter FeesType...." value="<?php echo$getSinglefeesData['feestype'] ;?>">
								</div>
							</div>
